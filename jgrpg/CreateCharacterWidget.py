...
class CreateCharacterWidget(
    ...
    def __init__(self, *, obj=None, race=None):
        print("CreateCharacterWidget(obj={}, race={})".format(
            obj, race))
    ...
    def reset(self):
        if self.obj:
            ...
            self.setWindowTitle("Edit {} (Character)".format(character.name))

            # Set the name line edit
            self.nameLineEdit.setText(character.name)
